...
const ProjectsPage: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    {
      id: '5',
      title: 'Schweizer Filmpreis Portärt',
      role: 'Director',
      year: '2024',
      logline: 'Interview with cinematographer Joseph Areddy',
    ...
    {
      id: '6',
      title: 'Personal Effects - In Development',
      role: 'Writer/Director',
      year: '2027',
      logline: 'A smalltime crook has to serve social hours in a childrens theater',
      image: '/images/projects/project-6.jpg',
      details: {
        director: 'Till Marti',
        genre: 'Crime Comedy',
        synopsis: 'A smalltime crook has to serve social hours in a childrens theater and gets the chance to direct a stage play.'
      }
    },
    {
      id: '7',
      title: 'Love is Due on Sycamore Street',
      role: 'Director',
      year: '2025',
      logline: 'While her little sister and the neighborhood kids battle a monstrous experiment gone wrong, a teenage girl and her boyfriend are determined to make their awkward first time a night to remember.',
      image: '/images/projects/love_is_due_on_sycamore_street/still_2025-11-18_084738_1.39.1.jpg',
      images: [
        '/images/projects/love_is_due_on_sycamore_street/still_2025-11-18_084738_1.39.1.jpg',
        '/images/projects/love_is_due_on_sycamore_street/still_2025-11-18_084738_1.98.1.jpg',
        '/images/projects/love_is_due_on_sycamore_street/still_2025-11-20_082401_1.2.1.jpg',
        '/images/projects/love_is_due_on_sycamore_street/still_2025-11-23_004614_1.24.1.jpg',
        '/images/projects/love_is_due_on_sycamore_street/still_2025-11-25_133722_1.27.1.jpg',
        '/images/projects/love_is_due_on_sycamore_street/still_2025-11-25_133722_2.14.1.jpg'
      ],
      details: {
        director: 'Till Gerber',
        cast: ['Cybèle Zinsli'],
        genre: 'Horror',
        duration: '40 min',
      }
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-8">
          <h1 className="font-space-grotesk font-bold text-4xl md:text-5xl tracking-tight mb-16">
            Full Portfolio
          </h1>
